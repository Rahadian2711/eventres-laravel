...
<head>
    ...
    <title>Register – Melodia</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="min-h-screen bg-slate-50 dark:bg-[#060B1F] flex items-center justify-center px-4 py-10 transition-colors duration-300">

    <div class="fixed inset-0 pointer-events-none overflow-hidden">
        <div class="absolute top-0 right-1/4 w-96 h-96 bg-[#EC4899]/8 rounded-full blur-[100px]"></div>
        <div class="absolute bottom-1/4 left-1/4 w-80 h-80 bg-purple-600/8 rounded-full blur-[100px]"></div>
    </div>
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white dark:bg-[#0F172A] border border-gray-100 dark:border-white/8 rounded-3xl p-8 shadow-xl dark:shadow-2xl">
            ...
            <div class="mb-7">
                <h1 class="text-2xl font-extrabold text-gray-900 dark:text-white">Buat Akun Baru</h1>
                <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">Daftar dan mulai temukan konser favoritmu</p>
            </div>
            ...
            <p class="text-center text-sm text-gray-500 dark:text-slate-400 mt-6">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-[#EC4899] font-semibold hover:text-pink-400 transition">Masuk di sini</a>
            </p>
        </div>
